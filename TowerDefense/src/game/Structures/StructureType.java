...
public enum StructureType {
	...
	GREEN_TOWER_BOTTOM_2("assets/Sprites/Tower tiles/Green tower/block(2).png", 63, 64, 44),
	...
	YELLOW_TOWER_BOTTOM_1("assets/Sprites/Tower tiles/Yellow tower/block(1).png", 63, 64, 44),
	YELLOW_TOWER_BOTTOM_2("assets/Sprites/Tower tiles/Yellow tower/block(2).png", 63, 64, 44),
	YELLOW_TOWER_BOTTOM_3("assets/Sprites/Tower tiles/Yellow tower/block(3).png", 75, 71, 48),
	...
	YELLOW_TOWER_TOP_1("assets/Sprites/Tower tiles/Yellow tower/block(5).png", 75, 70, 50),
	YELLOW_TOWER_TOP_2("assets/Sprites/Tower tiles/Yellow tower/block(6).png", 75, 70, 50),
	...
	RED_TOWER_BOTTOM_1("assets/Sprites/Tower tiles/Red tower/block(1).png", 63, 64, 44),
	RED_TOWER_BOTTOM_2("assets/Sprites/Tower tiles/Red tower/block(2).png", 63, 64, 44),
	RED_TOWER_BOTTOM_3("assets/Sprites/Tower tiles/Red tower/block(3).png", 75, 71, 48),
	...
	RED_TOWER_TOP_1("assets/Sprites/Tower tiles/Red tower/block(6).png", 75, 70, 50),
	RED_TOWER_TOP_2("assets/Sprites/Tower tiles/Red tower/block(7).png", 75, 70, 50),
	...
	PURPLE_TOWER_BOTTOM_1("assets/Sprites/Tower tiles/Purple tower/block(1).png", 63, 64, 44),
	PURPLE_TOWER_BOTTOM_2("assets/Sprites/Tower tiles/Purple tower/block(2).png", 63, 64, 44),
	PURPLE_TOWER_BOTTOM_3("assets/Sprites/Tower tiles/Purple tower/block(3).png", 75, 71, 48),
	...
	PURPLE_TOWER_TOP_1("assets/Sprites/Tower tiles/Purple tower/block(6).png", 75, 70, 50),
	PURPLE_TOWER_TOP_2("assets/Sprites/Tower tiles/Purple tower/block(7).png", 75, 70, 50),
